...
public class ExtendReportUtility {
	...
	public static final ExtentReports extentReports = new ExtentReports(); //Creating object

	public synchronized static ExtentReports createExtentReports() 
	{
		//Used to provide the location for the report																
		...
		extentReports.setSystemInfo("Name", "Theertha");// team membersname
